...
//third adpter
        List<String> nestedLists1 = new ArrayList<>();
        nestedList1.add("Jams and Honey");
        nestedList1.add("Pickles and Chutneys");
        nestedList1.add("Readymade Meals");


        List<String> nestedLists2 = new ArrayList<>();
        nestedList2.add("Book");
        nestedList2.add("Pen");
        nestedList2.add("Office Chair");
        nestedList2.add("Pencil");
        ...
        List<String> nestedLists3 = new ArrayList<>();
        nestedList3.add("Decorates");
        nestedList3.add("Tea Table");
        nestedList3.add("Wall Paint");
        nestedList3.add("Furniture");
        ...
        List<String> nestedLists4 = new ArrayList<>();
        nestedList4.add("Pasta");
        nestedList4.add("Spices");
        nestedList4.add("Salt");
        nestedList4.add("Salt");

        List<String> nestedLists5 = new ArrayList<>();
        nestedList5.add("Jams and Honey");
        nestedList5.add("Pickles and Chutneys");
        nestedList5.add("Readymade Meals");
        nestedList5.add("Chyawanprash and Health Foods");
        ...
        List<String> nestedLists6 = new ArrayList<>();
        nestedList6.add("Pasta");
        nestedList6.add("Spices");
        nestedList6.add("Salt");
        nestedList6.add("Chyawanprash");
        ...
        List<String> nestedLists7 = new ArrayList<>();
        nestedList7.add("Decorates");
        nestedList7.add("Tea Table");
        nestedList7.add("Wall Paint");
        nestedList7.add("Furniture");
        ...
        mList.add(new DataModel(nestedList1 , "Instant Food and Noodles",R.drawable.audio));
        mList.add(new DataModel( nestedList2,"Stationary",R.drawable.audio));
        mList.add(new DataModel( nestedList3,"Home Care",R.drawable.audio));
        mList.add(new DataModel(nestedList4 ,"Grocery & Staples",R.drawable.audio));
        mList.add(new DataModel(nestedList5,"Pet Care",R.drawable.audio));
        mList.add(new DataModel(nestedList6,"Baby Care",R.drawable.audio));
        mList.add(new DataModel(nestedList7,"Personal Care",R.drawable.audio));
